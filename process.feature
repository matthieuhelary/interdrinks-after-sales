...
And I ask him to cancel or proceed his order
	...
	@pwa @waiting-orders
	Scenario: Define out of stock products
	...
	@api @waiting-orders
	Scenario: Change order status when a waiting order is created
	...
	Scenario: As an employee, I can create a waiting order
		...
		"""
		Then a waiting order should be created
	...
	@api	
	Scenario: As an employee, I can update a waiting order
	...
	@api
	Scenario: If a waiting order is created
	...
	@api	
	Scenario: As a customer, I cannot create a waiting order
	...
	@api
	Scenario: As an employee, I can access to the list of waiting order with a filter by status
		Given I am authenticated as an employee
